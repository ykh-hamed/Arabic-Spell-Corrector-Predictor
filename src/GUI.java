...
public class GUI {
    ...
    public GUI() {
        ...
        Font bigFont = f.getFont().deriveFont(Font.PLAIN, 50f);
        f.setFont(bigFont);
...
class AutoSuggestor {
    ...
    public String getCurrentlyTypedWord() {//get newest word after last white spaceif any or the first word if no white spaces
        ...
        if (wordBeingTyped != null) {
            previousWord = wordBeingTyped.trim();
        }
        wordBeingTyped = "";
        if (text.contains(" ")) {
    ...
    boolean wordTyped(String typedWord) {
        ...
        if (typedWord.isEmpty()) {
            dictionary = x.getPredictions(previousWord);

        } else {
            dictionary = x.getCorrection(typedWord);
        }
        //System.out.println("Typed word: " + typedWord);

        boolean suggestionAdded = true;
...
class SuggestionLabel extends JLabel {
    ...
    public SuggestionLabel(String string, final Color borderColor, Color suggestionsTextColor, AutoSuggestor autoSuggestor) {
        ...
        Font bigFont = this.textField.getFont().deriveFont(Font.PLAIN, 50f);
    ...
    private void replaceWithSuggestedText() {
        ...
        autoSuggestor.previousWord=tmp;
